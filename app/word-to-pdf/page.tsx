...
export default function WordToPdfPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to convert Word to PDF. Please try again.",
        variant: "destructive",
      })
    } finally {
  ...
  const handleDownload = () => {
    if (convertedFile) {
      ...
      link.href = url
      link.download = `${selectedFile?.name?.replace(/\.(docx?|rtf)$/i, "") || "document"}.pdf`
            ...
            <div className="max-w-md mx-auto text-center">
              <Card>
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground mb-6">Your Word document has been converted to PDF format.</p>
